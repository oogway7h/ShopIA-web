  ...
  const reportesDeTienda = [
    {
      ...
      descripcion: 'Ver un dashboard interactivo de las ventas por día.',
      personalizado: true,
      personalizadoUrlId: 'ventas' 
    },
    {
      id: 'ventas-pdf',
      titulo: 'Reporte General de Ventas (PDF)',
      urlPath: '/api/reportes/ventas/pdf/', 
      fileName: 'reporte_ventas.pdf',
      descripcion: 'Descarga un listado general de todas las ventas completadas.',
      personalizado: false
    },
    {
      id: 'ventas-excel',
      titulo: 'Reporte de Ventas (Excel)',
      urlPath: '/api/reportes/ventas/excel/', 
      fileName: 'reporte_ventas_detallado.xlsx',
      descripcion: 'Descarga un listado detallado de ventas en formato Excel.',
      personalizado: false
    },
  ];
        ...
        <div className="bg-white rounded-2xl shadow-lg border border-gray-200 overflow-hidden">
          <div className="px-6 py-4 bg-gradient-to-r from-blue-50 to-white border-b border-gray-200">
            ...
            <p className="text-gray-600 text-sm mt-1">
              Descarga reportes en PDF o visualiza los dashboards.
            </p>
          </div>
          ...
          <div className="p-6 border-t border-gray-200">
            ...
            <p className="text-sm text-gray-500 mb-4">
              Presiona el botón y di un comando, como "generar reporte de ventas".
            </p>
            <VoiceCommandButton/>
          </div>
